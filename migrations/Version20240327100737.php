 ...
 */
final class Version20240327100737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD COLUMN redirection_mail BOOLEAN NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__employe AS SELECT id, groupe_principal_id, referent_id, nom, prenom, photo, sync_reseda, page_pro, idhal, orcid, mail_secondaire, telephone_secondaire, annee_naissance FROM employe');
        ...
        $this->addSql('INSERT INTO employe (id, groupe_principal_id, referent_id, nom, prenom, photo, sync_reseda, page_pro, idhal, orcid, mail_secondaire, telephone_secondaire, annee_naissance) SELECT id, groupe_principal_id, referent_id, nom, prenom, photo, sync_reseda, page_pro, idhal, orcid, mail_secondaire, telephone_secondaire, annee_naissance FROM __temp__employe');
