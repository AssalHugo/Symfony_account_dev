 ...
 */
final class Version20240326151408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE requetes ADD COLUMN date_requete DATE DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__requetes AS SELECT id, groupe_principal_id, localisation_id, referent_id, etat_requete_id, contrat_id, nom, prenom, mail, commentaire, telephone FROM requetes');
        ...
        $this->addSql('INSERT INTO requetes (id, groupe_principal_id, localisation_id, referent_id, etat_requete_id, contrat_id, nom, prenom, mail, commentaire, telephone) SELECT id, groupe_principal_id, localisation_id, referent_id, etat_requete_id, contrat_id, nom, prenom, mail, commentaire, telephone FROM __temp__requetes');
